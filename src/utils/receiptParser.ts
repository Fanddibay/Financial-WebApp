...
export function parseReceiptText(text: string): Partial<TransactionFormData> | Partial<TransactionFormData>[] {
  ...
  const result: Partial<TransactionFormData> = {
    ...
    category: merchant ? inferCategory(merchant) : 'Other',
    date,
  }
...
function inferCategory(text: string): string {
  ...
  const categoryKeywords: Record<string, string[]> = {
    Food: ['restaurant', 'cafe', 'food', 'grocery', 'market', 'supermarket', 'warung', 'makan', 'minum', 'kopi', 'bakso', 'nasi'],
    Transport: ['gas', 'fuel', 'bensin', 'taxi', 'uber', 'grab', 'gojek', 'parking', 'parkir', 'toll', 'tol'],
    Shopping: ['store', 'shop', 'toko', 'mall', 'retail', 'clothing', 'pakaian', 'shoes', 'sepatu'],
    Bills: ['utility', 'listrik', 'air', 'internet', 'phone', 'telepon', 'cable', 'bill', 'tagihan'],
    Entertainment: ['movie', 'cinema', 'bioskop', 'theater', 'game', 'entertainment'],
    Health: ['pharmacy', 'apotek', 'drug', 'obat', 'hospital', 'rumah sakit', 'clinic', 'klinik', 'doctor', 'dokter'],
  }
