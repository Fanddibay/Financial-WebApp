...
<template>
    <div class="mx-auto max-w-[430px] space-y-6 px-4 pb-32 pt-24">
        ...
        <BaseCard>
            <div class="space-y-6">
                ...
                <div class="flex flex-col items-center gap-4">
                    ...
                    <div v-if="!isEditing" class="text-xl font-semibold text-slate-900 dark:text-slate-100">
                ...
                <div v-if="isEditing" class="space-y-4">
                    ...
                    <div class="flex gap-3 pt-2">
                        <BaseButton variant="secondary" class="flex-1" @click="handleCancel">{{ t('common.cancel') }}
                        </BaseButton>
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-3 mb-4">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-lg bg-brand/10 flex-shrink-0">
                        ...
                        <div v-else-if="tokenStore.licenseStatus === 'checking'"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-blue-800 dark:text-blue-300">{{ t('license.checking')
                                    }}</p>
                            </div>
                        </div>
                        ...
                        <div v-else-if="tokenStore.licenseStatus === 'error'"
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-red-800 dark:text-red-300">{{ t('license.error') }}
                                </p>
                            </div>
                        ...
                        <div v-else
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-slate-700 dark:text-slate-300">{{ t('license.basic')
                                    }}</p>
                            </div>
                        </div>
                        ...
                        <div v-if="!tokenStore.isLicenseActive"
                            ...
                            <div class="flex items-start gap-3 mb-3">
                                ...
                                <div class="flex-1">
                                    <h4 class="mb-1 font-semibold text-slate-900 dark:text-slate-100">{{
                                        t('license.upgradeToPremium') }}
                                    </h4>
                            ...
                            <BaseButton class="w-full text-white" variant="teritary" size="sm"
                        ...
                        <div v-if="!tokenStore.isLicenseActive" class="space-y-3">
                            <div class="flex gap-2">
                                <div class="flex-1">
                                    <input v-model="licenseTokenInput" type="text"
                                ...
                                <BaseButton variant="secondary" size="sm" :disabled="isVerifyingLicense"
                                    @click="handlePasteLicense" class="shrink-0">
                            ...
                            <Transition enter-active-class="transition-all duration-200 ease-out"
                                ...
                                <div v-if="licenseError"
                                    ...
                                    <div class="flex items-start gap-2">
                                        ...
                                        <p class="text-xs text-red-800 dark:text-red-300 leading-relaxed flex-1">{{
                                            licenseError
                                            }}</p>
                                    </div>
                                </div>
                            ...
                            <!-- Activate Button -->
                            <BaseButton :loading="isVerifyingLicense"
                                :disabled="isVerifyingLicense || !licenseTokenInput.trim()" class="w-full"
                                @click="handleVerifyLicense">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <button type="button" @click="themeStore.toggleTheme()"
                        ...
                        <font-awesome-icon v-if="themeStore.theme === 'light'" :icon="['fas', 'moon']"
                            class="h-5 w-5" />
        ...
        <BaseCard>
            ...
            <div class="space-y-4">
                <div
                    class="rounded-lg bg-slate-50 p-4 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
        ...
        <BaseCard>
            <button type="button" @click="isPWAInstallOpen = !isPWAInstallOpen"
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-lg bg-brand/10 dark:bg-brand/20 flex-shrink-0">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div v-if="!isInstalled" class="space-y-2 mt-3">
                                    <div class="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
                                        <div
                                            class="flex h-6 w-6 items-center justify-center rounded-full bg-brand/10 dark:bg-brand/20">
                    ...
                    <div v-else-if="!isInstalled && !isInstallable"
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                ...
                                <ol
                                    class="text-sm text-blue-800 dark:text-blue-300 space-y-1.5 list-decimal list-inside">
        ...
        <ConfirmModal :is-open="showImportConfirm" :title="t('dataManagement.importConfirmTitle')"
            ...
            :cancel-text="t('common.cancel')" variant="info" :icon="['fas', 'circle-info']"
